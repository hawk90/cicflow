...
CIC_LLVM_TEST_ADDITIONAL_FLAGS = [
    "-Wno-deprecated-declarations",
...
COPT_VARS = {
    "CIC_GCC_FLAGS": CIC_GCC_FLAGS,
    "CIC_GCC_TEST_FLAGS": GccStyleFilterAndCombine(
        CIC_GCC_FLAGS, CIC_GCC_TEST_ADDITIONAL_FLAGS
    ),
    "CIC_LLVM_FLAGS": CIC_LLVM_FLAGS,
    "CIC_LLVM_TEST_FLAGS": GccStyleFilterAndCombine(
        CIC_LLVM_FLAGS, CIC_LLVM_TEST_ADDITIONAL_FLAGS
    ),
    "CIC_CLANG_CL_FLAGS": MSVC_BIG_WARNING_FLAGS + MSVC_DEFINES,
    "CIC_CLANG_CL_TEST_FLAGS": MSVC_BIG_WARNING_FLAGS
    + MSVC_DEFINES
    + CIC_LLVM_TEST_ADDITIONAL_FLAGS,
    "CIC_MSVC_FLAGS": MSVC_BIG_WARNING_FLAGS + MSVC_WARNING_FLAGS + MSVC_DEFINES,
    "CIC_MSVC_TEST_FLAGS": MSVC_BIG_WARNING_FLAGS
    + MSVC_WARNING_FLAGS
    + MSVC_DEFINES
    + [
    ...
    "CIC_RANDOM_HWAES_ARM64_FLAGS": ["-march=armv8-a+crypto"],
    "CIC_RANDOM_HWAES_ARM32_FLAGS": ["-mfpu=neon"],
    "CIC_RANDOM_HWAES_X64_FLAGS": [
        "-maes",
        "-msse4.1",
    ],
    "CIC_RANDOM_HWAES_MSVC_X64_FLAGS": [],
}
